        ...
        <div className="flex gap-2 p-1.5 bg-black/40 border border-oro/10 ninja-box w-full min-[1600px]:w-auto justify-center">
          {['active', 'inactive'].map((tab) => (
            ...
            >
              ...
              <span className={`ml-2 opacity-40 ${activeTab === tab ? 'text-naranja-naruto/60' : ''}`}>({subs.filter(s => tab === 'active' ? s.activo : !s.activo).length})</span>
            </button>
          ))}
        </div>
        ...
        <Portal>
          ...
          >
            ...
            <header className="flex flex-col sm:flex-row justify-between items-center gap-6 mb-10 relative z-10">
              ...
              <button onClick={() => setIsAdding(false)} className="p-2 text-oro/40 hover:text-naranja-naruto transition-all hover:rotate-90">
                <X className="w-8 h-8" />
              </button>
            </header>
        ...
        <Portal>
          ...
          >
            ...
            <header className="flex flex-col sm:flex-row justify-between items-center gap-6 mb-10 relative z-10">
              ...
              <button onClick={() => { setEditingId(null); setEditForm(null); }} className="p-2 text-oro/40 hover:text-naranja-naruto transition-all hover:rotate-90">
                <X className="w-8 h-8" />
              </button>
            </header>
