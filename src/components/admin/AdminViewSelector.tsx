    ...
    <section className="w-full max-w-[1750px] mx-auto mb-4 sm:mb-6 ninja-card-oro p-6 sm:p-8 xl:p-10 animate-in slide-in-from-top duration-500">
      ...
      <div className="flex gap-2 p-1.5 bg-black/40 border border-oro/10 ninja-box w-full sm:w-auto sm:inline-flex justify-center">
        <button
          ...
          className={`flex-1 sm:flex-initial text-center px-4 sm:px-10 py-3 xl:py-4 font-black uppercase tracking-[0.2em] transition-all text-caption sm:text-caption xl:text-xs ${viewMode === 'player'
        ...
        <button
          ...
          className={`flex-1 sm:flex-initial text-center px-4 sm:px-10 py-3 xl:py-4 font-black uppercase tracking-[0.2em] transition-all text-caption sm:text-caption xl:text-xs ${viewMode === 'admin'
              ? 'bg-oro text-naranja-naruto shadow-lg'
              : 'text-oro/40 hover:text-oro hover:bg-oro/5'
            }`}
          style={{ clipPath: 'polygon(8px 0, 100% 0, 100% calc(100% - 8px), calc(100% - 8px) 100%, 0 100%, 0 8px)' }}
