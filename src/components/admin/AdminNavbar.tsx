...
import { Settings, Map, ScrollText, ShoppingBag, GitBranch, Sword, FileText, ShieldCheck, ShieldAlert, LogOut, ChevronDown, LayoutDashboard, Flame, BookOpen, Eye, Shield, UserPlus, Users, Hammer } from 'lucide-react';
...
export default function AdminNavbar({ userRoles = [] }: AdminNavbarProps) {
  ...
  const menuItems: MenuItem[] = [
    ...
    { href: '/admin/acompanantes', label: 'Acompañantes', icon: Users },
    { href: '/admin/kugutsu', label: 'Componentes Kugutsu', icon: Hammer },
