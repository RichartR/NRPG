    ...
    <div className={`ninja-card-${color} p-8 xl:p-12 shadow-2xl ${className}`}>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-10 relative z-10">
        <div className="flex items-center gap-4">
          <img src="https://game.gtimg.cn/images/hyrz/web2026/content-news-head.png" className="w-4 xl:w-7 h-auto object-contain" alt="icon" />
          <h2 className="ninja-title text-3xl xl:text-5xl">{title}</h2>
        </div>
        {headerAction && (
