    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/45 backdrop-blur-sm animate-in fade-in duration-300">
      ...
      >
        ...
        <div className="relative z-10">
          <div 
            className={`p-5 mb-8 flex items-center gap-5 relative overflow-hidden border ${
              isDanger 
          ...
          >
            ...
            <div className="relative z-10 flex items-center gap-5 w-full">
              ...
              <div className="flex flex-col justify-center">
                <span className={`text-[9px] font-black uppercase tracking-[0.25em] leading-none mb-1.5 block ${
          ...
          {options.requireValidation && (
            <div className="mb-10 space-y-4 animate-in slide-in-from-top-2 duration-500">
              <label className="text-[10px] font-black uppercase tracking-[0.2em] text-[#050309]/60 ml-1 block">
