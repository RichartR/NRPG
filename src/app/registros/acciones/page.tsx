...
import { Zap, ChevronLeft, ChevronRight, Loader2, ArrowLeft, X } from 'lucide-react';
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-4xl font-black italic uppercase tracking-tighter flex items-center gap-3">
                ...
                Bitácora de <span className="text-emerald-500">Acciones</span>
              </h1>
              <p className="text-zinc-500 font-bold uppercase tracking-widest text-[10px] mt-1">Crónica de eventos y sucesos del mundo</p>
            </div>
          </div>
        </header>
          ...
          <div className="flex flex-wrap items-center gap-6 p-6 bg-zinc-900/30 border border-zinc-800/50 rounded-3xl animate-in fade-in slide-in-from-top-2 duration-500">
            <div className="flex items-center gap-3">
              ...
              <input 
                ...
                className="bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-2 text-xs text-white focus:border-emerald-500/50 outline-none transition-all"
              />
            </div>
            <div className="flex items-center gap-3">
          ...
          <div className="bg-zinc-900/30 border border-zinc-800/50 rounded-[2.5rem] p-8 backdrop-blur-xl">
            {loading ? (
              ...
              <div className="py-40 text-center border-2 border-dashed border-zinc-800/50 rounded-[3rem]">
                <Zap className="w-16 h-16 text-zinc-800 mx-auto mb-4" />
                <p className="text-xs font-bold text-zinc-600 uppercase tracking-widest italic">No hay acciones registradas todavía</p>
              </div>
            )}
          </div>
        </div>
