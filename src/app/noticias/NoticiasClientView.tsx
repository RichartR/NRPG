      ...
      <header className="w-full max-w-[1750px] mx-auto flex flex-col md:flex-row justify-between items-center gap-4 mb-10 ninja-card-oro p-6 sm:p-8 xl:p-10 relative z-50">
        ...
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl xl:text-2xl font-black text-oro uppercase tracking-[0.3em]">
            MURO <span className="text-naranja-naruto">DE ANUNCIOS</span>
          </h1>
        </div>
      </header>
            ...
            <header className="mb-6 ninja-card-oro p-8 xl:p-10">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-oro/40 text-caption xl:text-xs font-black uppercase tracking-[0.4em] mt-2">CONFIGURACIÓN DE ANUNCIOS Y COMUNICADOS</p>
                </div>
              </div>
            </header>
