    ...
    <div className="max-w-[1750px]">
      <header className="mb-6 ninja-card-oro p-8 xl:p-10">
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            <h1 className="ninja-title text-4xl xl:text-5xl italic">LORE Y ARCHIVO</h1>
            <p className="text-oro/40 text-caption xl:text-xs font-black uppercase tracking-[0.4em] mt-2">GESTIÓN DE DOCUMENTACIÓN HISTÓRICA Y GUÍAS</p>
          </div>
        </div>
      </header>
